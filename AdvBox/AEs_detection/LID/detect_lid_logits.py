...
def main(args):
    ...
    #X_test = paddle.transpose(paddle.to_tensor(X_test), [0, 3, 1, 2])
    #X_test_adv = paddle.transpose(paddle.to_tensor(X_test_adv), [0, 3, 1, 2])
    #X_test_noisy = paddle.transpose(paddle.to_tensor(X_test_noisy, paddle.float32), [0, 3, 1, 2])
