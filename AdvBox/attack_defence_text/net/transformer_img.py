...
class Encoder(nn.Module):
    def __init__(self, img_size, embed_dim, num_heads, num_layers, ff_dim, dropout, max_len):
...
class TransformerClassifier(nn.Module):
    def __init__(self, img_size, embed_dim, num_heads, num_layers, ff_dim, num_classes, dropout, max_len):
        super(TransformerClassifier, self).__init__()
        self.encoder = Encoder(img_size, embed_dim, num_heads, num_layers, ff_dim, dropout, max_len)
