...
"""
BIM tutorial on imagenet using the attact tool.
BIM method is a non-targeted attack tool.
"""
...
def main(image_path):
    ...
    if adversary.is_successful():
        ...
        # adv = adversary.adversarial_example[0].numpy()
        ...
        cv2.imwrite('output/img_adv_bim.png', adv_cv)
