...
"""
MIFGSM tutorial on imagenet using the attack tool.
"""
...
def main(image_path):
    ...
    # 设定epsilons  
    attack_config = {"epsilons": 0.3, "epsilon_steps": 10, "steps": 100}
    ...
    if adversary.is_successful():
        ...
        cv2.imwrite('output/img_adv_mifgsm.png', adv_cv)
