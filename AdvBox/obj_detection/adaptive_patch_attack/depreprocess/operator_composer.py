...
"""
import traceback
from . import depreprocess_operators
...
class OperatorComposer(object):
    def __init__(self, operators1, num_classes=80):
        self.operators = operators1
        self.operators_cls = []
        for operator_name in self.operators:
