...
"""
The patch position and size determination for all training images.
Contains:
* PatchTransformer: transforms batch of patches.
* PatchApplier: applies adversarial patches to training images.
...
class PatchTransformer(nn.Layer):
    ...
    def forward(self, adv_patch, lab_batch, img_size, patch_scale, patchxy_scale, do_rotate=True, rand_loc=True):
        ...
        adv_patch = adv_patch_pool.unsqueeze(0)#.unsqueeze(0)
