...
"""
The image transformation matrix computation.
Contains:
* give a sample image and the object information.
* Generate sample transformation matrix.
