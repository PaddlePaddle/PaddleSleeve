    ...
    def apply(self, sample, context=None):
        ...
        if 'image' not in sample:
            with open(sample['im_file'], 'rb') as f:
                ...
                lab_path = sample['im_file'].replace("truck_toy", "truck_toy/truck_toy_label").replace('.jpg', '.txt').replace('.png', '.txt')
                ...
                if(pad_size>0):
                    label = np.pad(label, ((0, pad_size), (0, 0)), 'constant',constant_values = (1, 1))
