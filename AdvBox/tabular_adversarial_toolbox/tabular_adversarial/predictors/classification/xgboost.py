...
class XGBoostClassifier(object):
    '''
    Classifier using xgboost model.
    '''
    ...
    def __init__(
        ...
        '''
        Create a Classifier from a XGBoost model.
        ...
        Args:
            ...
            nb_classes: The number of classes in the training data. 
        '''
    ...
    def predict(self, x):
        ...
        Returns:
            y_pred (numpy.ndarray): Array of predictions of shape (nb_inputs, nb_classes).
        '''
